package com.honorwise.snakegame;
...
timer.scheduleAtFixedRate(new TimerTask() {
    ...
    builder.show();
        ...
        for(int i=0;i<snakePointsList.size();i++)
        {
            ...
            int getTemPositionY=snakePointsList.get(i).getPositionY();
    ...
    private boolean checkGameOver(int headPositionX,int headPositionY)
    {
        ...
        if(snakePointsList.get(0).getPositionX()<0 || snakePointsList.get(0).getPositionY()<0 || snakePointsList.get(0).getPositionX()>=surfaceView.getWidth()
